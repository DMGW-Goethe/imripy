...
plotWaveform(sp_0, t_0, a_0, e_0, ax_h, f_start=1e-2*ms.hz_to_invpc, label="0")
plotWaveform(sp_1, t_1, a_1, e_1, ax_h, f_start=1e-2*ms.hz_to_invpc, label="1")
